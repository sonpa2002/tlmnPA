...
function thebodyonload(){
    ...
    restoreBtn.addEventListener("click",khoiphucbandulieucu);
    resetBtn.addEventListener("click",taobandulieumoi);
    ...
    if (localStorage.getItem('DateTime') !== null)
    {
        ...
        document.querySelector('.conf-popup').style.display = "block";
    }
    else
    {
        removeEventListenerrestoreBtnAndresetBtn();
    }
}
function huy_hotro(){
    if(next==3)
...
function khoiphucdulieu(){
    if (van==1 && localStorage.getItem('DateTime') !== null){
...
function removeEventListenerrestoreBtnAndresetBtn(){
    var restoreBtn=document.getElementById("restore");
    var resetBtn=document.getElementById("reset");
    restoreBtn.removeEventListener("click",khoiphucbandulieucu);
    resetBtn.removeEventListener("click",taobandulieumoi);
    changeConfirmPopup();
}
function taobandulieumoi(){
    //xử lý khi nhấn tạo mới
    xoadulieulocalstorage();
    document.querySelector('.conf-popup').style.display = "none";
    removeEventListenerrestoreBtnAndresetBtn();
}
function khoiphucbandulieucu(){
    //xử lý khi nhấn khôi phục
    khoiphucdulieu();
    document.querySelector('.conf-popup').style.display = "none";
    removeEventListenerrestoreBtnAndresetBtn();
}
function changeConfirmPopup(){
    var message=document.getElementById("conf-popup-noidungthongbao");
    var luuBtn=document.getElementById("restore");
    var nhaplaiBtn=document.getElementById("reset");
    message.innerHTML="Phát hiện dữ liệu bất thường! Bạn có muốn tiếp tục lưu dữ liệu này?";
    luuBtn.setAttribute("id","save");
    nhaplaiBtn.setAttribute("id","re-enter");
    luuBtn.innerHTML="&nbsp;&nbsp;&nbsp;Lưu&nbsp;&nbsp;&nbsp;";
    nhaplaiBtn.innerHTML="Nhập lại";
}
function showDialog() {
  return new Promise((resolve, reject) => {
    const confirmpopup = document.querySelector('.conf-popup');
    const luuBtn=document.getElementById("save");
    const nhaplaiBtn=document.getElementById("re-enter");
    
    luuBtn.onclick=function (){
        confirmpopup.style.display = "none";
        resolve(true);
    };
    nhaplaiBtn.onclick=function (){
        confirmpopup.style.display = "none";
        resolve(false);
    };
